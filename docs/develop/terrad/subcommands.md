...
For information about generating multisignature accounts and signing transactions, see [Sign with a multisig account](../how-to/sign-with-multisig.mdsign-with-multisig.md).
